function varargout = Xml_analyzer_V3(varargin)
% XML_ANALYZER_V3 MATLAB code for Xml_analyzer_V3.fig
%      XML_ANALYZER_V3, by itself, creates a new XML_ANALYZER_V3 or raises the existing
%      singleton*.
%
%      H = XML_ANALYZER_V3 returns the handle to a new XML_ANALYZER_V3 or the handle to
%      the existing singleton*.
%
%      XML_ANALYZER_V3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in XML_ANALYZER_V3.M with the given input arguments.
%
%      XML_ANALYZER_V3('Property','Value',...) creates a new XML_ANALYZER_V3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Xml_analyzer_V3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Xml_analyzer_V3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Xml_analyzer_V3

% Last Modified by GUIDE v2.5 07-Apr-2016 19:41:48

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Xml_analyzer_V3_OpeningFcn, ...
                   'gui_OutputFcn',  @Xml_analyzer_V3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Xml_analyzer_V3 is made visible.
function Xml_analyzer_V3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Xml_analyzer_V3 (see VARARGIN)

% Choose default command line output for Xml_analyzer_V3
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Xml_analyzer_V3 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Xml_analyzer_V3_OutputFcn(hObject, eventdata, handles) 
...
xml_extraction_n_make_write1_txt_file(handles.SelectedName,handles.folder_path,handles.foldername)
